...
Уколико радцимо са структурираним подацима, онда је ова фаза лакша. Међутим, када су у питању неструктурирани и полуструктурирани подаци, они морају прво да буду означени што може бити дуготрајан и напоран процес.
